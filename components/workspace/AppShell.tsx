            ...
            <div className="relative">
              ...
              {menuOpen ? (
                <div className="absolute right-0 mt-2 w-72 rounded-lg border bg-card p-2 shadow-lg">
                  ...
                  <MenuLink href="/profile" label="个人资料" icon={UserRound} />
                  <MenuLink href="/profile" label="账号设置" icon={Settings} />
                  <MenuLink href="/about" label="申请指南" icon={MapPinned} />
                  <MenuLink href="/feedback" label="帮助与联系" icon={LifeBuoy} />
                  <MenuLink href="/feedback" label="反馈问题" icon={MessageSquare} />
...
function MenuLink({
  ...
  return (
    <Link className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-muted" href={href}>
